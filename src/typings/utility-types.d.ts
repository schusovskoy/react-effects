...
type ArgType<N extends number, T extends (...args: any[]) => any> = N extends 0
  ? T extends (arg0: infer U, ...args: any[]) => any
    ? U
    : never
  : N extends 1
  ? T extends (arg0: any, arg1: infer U, ...args: any[]) => any
    ? U
    : never
  : N extends 2
  ? T extends (arg0: any, arg1: any, arg2: infer U, ...args: any[]) => any
    ? U
    : never
  : N extends 3
  ? T extends (
